...
const res = await p.evaluate(async () => {
  ...
  const movs = [{ kind: "estimated_sale", delta: -5, value_est: 500, unit_price_incl: 100, unit_price_excl: 80, location: "br", sku: "A1", sku_name: "صنف", upload_id: "U1", captured_at: now, period_days: 2 }];
